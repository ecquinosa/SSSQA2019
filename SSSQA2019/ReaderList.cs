                ...
                while (!bStopThread)    // loop 1 - build list, then iterate
                {
                    ...
                    while (!bStopThread)    // loop 2 - iterate over list built above
                    {
                                ...
                                else
                                {
                                    ...
                                    if ((states[i].dwEventState & SCARD.STATE_PRESENT) != 0)
                                    {
                                        ...
                                        {                                            
                                            ...
                                            if (CardPresented != null) CardPresented(states[i].szReader, cardData);                                            
                                        }
                                    }
                                    else
                        ...
                        if (bReaderListChanged)
                        {
                            ...
                            System.Windows.Forms.MessageBox.Show("No reader is detected");
                            else
                            System.Windows.Forms.MessageBox.Show("Reader is detected");
